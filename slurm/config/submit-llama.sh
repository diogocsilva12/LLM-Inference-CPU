...
usage() {
  cat <<'EOF'
Usage:
  slurm/config/submit-llama.sh build     <profile> [repo_dir]
  slurm/config/submit-llama.sh run       <profile> [model_path]
  slurm/config/submit-llama.sh benchmark <profile> [model_path]
  slurm/config/submit-llama.sh prebuild [profiles...]
...
Examples:
  slurm/config/submit-llama.sh build arm-cpu
  slurm/config/submit-llama.sh build a100-cuda
  slurm/config/submit-llama.sh run a100-cuda /path/model.gguf
  slurm/config/submit-llama.sh benchmark a100-cuda /path/model.gguf
  slurm/config/submit-llama.sh prebuild arm-cpu a100-cuda
