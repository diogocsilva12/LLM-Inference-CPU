#!/usr/bin/env bash
#SBATCH --job-name=a1-vllm-mlc-sweep-x86
...
WRAPPER_SCRIPT="$PROJECT_DIR/slurm/sweep_benchmark/run-track-a1-vllm-mlc-sweep-x86.sh"
...
export OUTPUT_SUFFIX="${OUTPUT_SUFFIX:-track-a1-vllm-mlc-sweep-x86}"
...
# x86-targeted run on 126 cores as requested.
