...
WRAPPER_SCRIPT="$PROJECT_DIR/slurm/sweep_benchmark/run-track-a1-mlc-sweep.sh"
...
export PROJECT_DIR
export OUTPUT_SUFFIX="${OUTPUT_SUFFIX:-track-a1-mlc-sweep}"
