...
WRAPPER_SCRIPT="$PROJECT_DIR/slurm/sweep_benchmark/run-track-a1-vllm-sweep.sh"
...
export PROJECT_DIR
export OUTPUT_SUFFIX="${OUTPUT_SUFFIX:-track-a1-vllm-sweep}"
...
# ARM defaults. The base harness still lets you override every dimension.
export THREADS="${THREADS:-46}"
export THREADS_BATCH="${THREADS_BATCH:-46}"
export THREADS_LIST="${THREADS_LIST:-12 24 36 40 42 44 46 48}"
